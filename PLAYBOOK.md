...
└─ Monday 06:00 UTC  produce.yml  →  run_produce.py
      ...
      3. pipeline/tts.py       edge-tts per section → mp3 + word timings; concat + loudnorm
         ...
         pipeline/motion.py    animated PIL cards: bignumber | compare | list | formula | callout | timeline | chart | chapter
         pipeline/visuals.py   static helpers, chart drawing, Pexels b-roll, lower-third
